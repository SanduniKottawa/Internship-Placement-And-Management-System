                        ...
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-3" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="view1_dailydairy.ph">View  and Print Diary Diary</a>
                                        </li>
                                        <li class="nav-item">
        ...
        <div class="dashboard-wrapper" style='background-image: url(img/bdl.jpg)'>
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content" id="invoice">
                    ...
                    <h2>Students Daily Diary Reports</h2>
                    <!-- ============================================================== -->
                    <!-- end pageheader  -->
                    <!-- ============================================================== -->
                    <div class="row">
...
$id=$_SESSION['username'];
    ...
    $se="select * from student_diary where student_id=$id";
    ...
    echo "<table style='color:black; font-size:13px' class='table table-striped '>";
        ...
        echo "<tr>";
            echo "<td>"."WEEK 10"."</td>";
            echo "<td>".":".$row['week10']."</td>";
        echo "</tr>";

        echo "<tr>";
         echo "<td>"."WEEK 11"."</td>";
         echo "<td>".":".$row['week11']."</td>";
        echo "</tr>";

        echo "<tr>";
            echo "<td>"."WEEK 12"."</td>";
            echo "<td>".":".$row['week12']."</td>";
        echo "</tr>";
