                                    ...
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <div id="submenu-1-1" class="collapse submenu" style="">
                                                <ul class="nav flex-column">
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="http://localhost/ipms/add_stupassword.php">Student</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="http://localhost/ipms/add_adminpassword.php">Admin</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h1 class="pageheader-title">Progress reports on industrial training performance </h1>
								<pre class="tab"></pre>
								<pre class="tab"></pre>
