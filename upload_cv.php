                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-3" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="">View and Print Novation Report </a>
                                        </li>
                                        <li class="nav-item">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="span6" id="form-login">
                <form class="form-horizontal well" action="upload.php" method="post" name="upload_cv" enctype="multipart/form-data">
                    <fieldset>
                        <legend>UPLOAD CV </legend>
                        <div class="control-group">
                            
                            <div class="controls">
                                <label>CV FILES :-</label><input type="file" name="file" id="file" class="input-large">
                            </div>
                        </div>
                        
                        <br>
                        <br>
                        <li>Note: Rename your CV with your Registration Number (SC/XXXX/XXXXX)</li>
