...
$sql="SELECT  * FROM student LEFT JOIN status on student.student_id = status.student_ID";
             ...
             <div class="table-responsive">
                <table class="table table-striped table-bordered first">
                    <tr>
                             <th>Student ID</th>
                             <th>Student Name</th>
                             <th>Interview Placement</th>
                             <th>Compant Selection</th>
                     ...
                     <tr>
                                     ...
                                     <td><?php echo $row["interview_placement"]; ?></td>
                                     <td><?php echo $row["company_selection"]; ?></td>
