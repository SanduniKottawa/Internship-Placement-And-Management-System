...
<body>
                                ...
                                <div id="submenu-3" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                         ...
                                         </li>   <a class="nav-link" href="novation_rpeport.php">Edit Novation Repor</a>
                                        </li>
    ...
    <form action="status_action.php" method="post" id="login-form" class="form-horizontal">
        <div class="form-group">
            <label for="username" class="text-info">Student Id:</label><br>
            <input type="text" name="id" id="username" class="form-control">
        </div>
        <div class="form-group">
            <label for="username" class="text-info">interview_placement:</label><br>

                        <select class="form-select" name="placement" aria-label="Default select example">
        ...
        <div class="form-group">
            <label for="username" class="text-info">Company Selection</label><br>
