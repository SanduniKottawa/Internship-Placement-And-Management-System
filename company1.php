                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h1 class="pageheader-title"></br></br>Progress reports on industrial training performance </h1>
								<pre class="tab"></pre>
								<pre class="tab"></pre>
	...
	<div class="container">
		...
		<br><br>
			...
			<?php
			    ...
			    $SQLSELECT = "SELECT DISTINCT place_of_traning FROM novation_report";    //change table name 
				...
				?>
					    ...
					    <h1><a href="view_reports.php?place_of_traning=<?php echo $row['place_of_traning']; ?>"><?php echo $row['place_of_traning']; ?></a></h1>
