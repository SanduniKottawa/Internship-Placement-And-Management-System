...
<body>
        ...
        <div class="dashboard-wrapper" style='background-image: url(img/bdl.jpg)'>
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <h7>***Click Student ID to view Daily Diary</h7>
                    <!-- ============================================================== -->
                    <!-- end pageheader  -->
                    <!-- ============================================================== -->
                    <div class="row">
 ...
 <table class="table table-bordered">
            ...
            $SQLSELECT="SELECT  * FROM student LEFT JOIN student_diary on student.student_id = student_diary.student_id";
                //$SQLSELECT = "SELECT * FROM student_diary ";    //change table name 
