...
if( isset($_GET['search'])) {
    $search= mysqli_real_escape_string($connect, $_GET['form-control']);
    $sql= "SELECT * FROM student LEFT JOIN rank on student.student_id = rank.student_ID where (full_name like '%{$search}%' or student_id like '%{$search}%' or prefered_area like '%{$search}%')";
}else{

    $sql="SELECT student.student_id, student.full_name, student.prefered_area,rank.overall_rank,novation_report.place_of_traning FROM student LEFT JOIN rank on student.student_id = rank.student_ID LEFT JOIN novation_report on  student.student_id = novation_report.student_ID " ;
}
            ...
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                   ...
                   <!-- ============================================================== -->
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Company Selection</h5>
                            <div class="card-body">
                                   ...
                                   <table class="table table-striped table-bordered first">
                                       <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row["prefered_area"]; ?></td>
                                        ...
                                        // $id=$_SESSION['username'];
                                              ...
                                              // $se="SELECT * FROM novation_report left JOIN student on student.student_id = novation_report.student_id";
                                                
                                               //$q=mysqli_query($connection,$se);
                                                
                                               //$row=mysqli_fetch_assoc($q);

                                                echo $row['place_of_traning'];   
